...
inp1 = Entry(root, textvariable=entry_text1, font=('FangSong', 10), width=30, state='readonly')
inp1.place(relx=0.23, rely=0.33, relwidth=0.25, relheight=0.05)
entry_text2 = StringVar()
inp2 = Entry(root, textvariable=entry_text2, font=('FangSong', 10), width=30, state='readonly')
...
inp4 = Entry(root, textvariable=entry_text4, font=('FangSong', 10), width=30, state='readonly')
inp4.place(relx=0.23, rely=0.57, relwidth=0.25, relheight=0.05)
entry_text5 = StringVar()
inp5 = Entry(root, textvariable=entry_text5, font=('FangSong', 10), width=30, state='readonly')
...
inp7 = Entry(root, textvariable=entry_text7, font=('FangSong', 10), width=30, state='readonly')
inp7.place(relx=0.73, rely=0.33, relwidth=0.25, relheight=0.05)
entry_text8 = StringVar()
inp8 = Entry(root, textvariable=entry_text8, font=('FangSong', 10), width=30, state='readonly')
inp8.place(relx=0.73, rely=0.41, relwidth=0.25, relheight=0.05)
entry_text9 = StringVar()
inp9 = Entry(root, textvariable=entry_text9, font=('FangSong', 10), width=30, state='readonly')
inp9.place(relx=0.73, rely=0.49, relwidth=0.25, relheight=0.05)
entry_text10 = StringVar()
inp10 = Entry(root, textvariable=entry_text10, font=('FangSong', 10), width=30, state='readonly')
inp10.place(relx=0.73, rely=0.57, relwidth=0.25, relheight=0.05)
entry_text11 = StringVar()
inp11 = Entry(root, textvariable=entry_text11, font=('FangSong', 10), width=30, state='readonly')
inp11.place(relx=0.73, rely=0.65, relwidth=0.25, relheight=0.05)
entry_text12 = StringVar()
inp12 = Entry(root, textvariable=entry_text12, font=('FangSong', 10), width=30, state='readonly')
